...
request.Headers.Add("ServiceBusNotification-Format", "▼ [ Select Option 1 ]");

request.Content = new StringContent(payload, Encoding.UTF8, "▼ [ Select Option 2 ]");
...
< ▼ [ Select Option 1 ] >
  <base />
  <choose>
    <when condition = " @( ▼ [ Select Option 2 ] .Response.StatusCode == 500
      && ▼ [ Select Option 3 ] .LastError.Message.Contains("conflict")) " >
      <return-response>
        < ▼ [ Select Option 4 ] code="409" reason="Conflict" />
      </return-response>
    </when>
    <otherwise />
  </choose>
