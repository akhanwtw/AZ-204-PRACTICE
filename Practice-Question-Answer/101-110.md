...
2.  **Protection:** Because the data is encrypted at the object level, anyone who downloads the blob—whether an authorized user or a malicious third party—receives only the encrypted bytes.
